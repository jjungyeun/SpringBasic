...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        assertEquals("상품 주문 시 상태는 ORDER", OrderStatus.ORDER, savedOrder.getStatus());
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문 취소 시 상태는 CANCEL", OrderStatus.CANCEL, canceledOrder.getStatus());
        assertEquals("재고가 원래대로 돌아와야 한다.", 10, book.getStockQuantity());
